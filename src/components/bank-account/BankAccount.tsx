...
import { star, upload, eye, leftArrow } from "../../assets/icons";
    ...
    <>
      <div className="flex flex-col justify-center mb-10 mx-3 gap-5 px-5 py-10 min-h-fit w-11/12 shadow rounded-lg bg-white">
        ...
        <div className="flex justify-between">
          ...
          <span>
            {account.bilancio
              ? account.bilancio * 0.75 + " " + account.valuta
      ...
      <div className="flex pt-10 min-w-full justify-center bg-white">
        <NavLink to="/profile/conto/movimenti">
          <button className="flex place-items-center gap-2 active:text-green">Vai a movimenti<span>{leftArrow}</span></button>
        </NavLink>
      </div>
    </>
  );
